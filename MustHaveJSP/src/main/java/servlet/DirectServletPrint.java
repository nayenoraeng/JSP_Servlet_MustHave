...
public class DirectServletPrint extends HttpServlet {
	...
	/*
		사용자가 post 방식으로 전송한 요청을 처리하기 위해 doPost() 메서드를
	...
	*/
	...
	{
		//서블릿에서 직접 HTML 태그를 출력하기 위해 문서의 컨텐츠 타입을
		//설정한다. 콘텐츠 타입은 "text/html"으로 캐릭터셋은 "UTF-8"로 설정
		resp.setContentType("text/html;charset=UTF-8");
		//직접 출력을 위해 PrintWriter 객체 생성
		...
		writer.close();
		/*
			이 방식은 JSP페이지 없이 서블릿에서 직접 내용을 출력해야 할때
			사용한다. API통신시 (xml, json) 주로 사용하게 된다.
