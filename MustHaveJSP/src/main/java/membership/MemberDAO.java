...
/*
	DAO : 실제 데이터베이스에 접근하여 여러가지 CRUD작업을 하기 위한 객체
*/
//DB 연결은 자주 쓰이는 작업이므로 이와 같이 상속으로 처리하면 편리하다.
public class MemberDAO extends JDBConnect {
	
	//생성자 메서드
	//매개변수가 4개인 부모생성자를 호출하여 DB에 연결한다.
	...
	/*
		사용자가 입력한 아이디, 패스워드를 통해 회원테이블을 select 한 후
