...
<html>
	...
	<body>
		...
		<!-- 자동형 변환이 적용되므로 정수끼리의 연산에서 실수의 결과가 나올 수 있다 -->
		num3 div num4 : ${ num3 div num4 } <br/>
		num3 % num4 : ${ num3 % num4 } <br/>
		num3 mod num4 : ${ num3mod% num4 }
		
		<!-- EL에서는 +는 덧셈연산만 가능하고 문자열의 연결에는 사용되지 않는다. -->
		<h3>+ 연산자는 덧셈만 가능</h3>
		num1 + "34" : ${ num1 + "34" } <br />
		<!--  하지만 숫자와 문자열 혹은 문자열과 문자열의 경우에는 연산이 불가능하므로
		예외가 발생한다. -->
		num2 + "이십" : \${ num2 + "이십" } <br />
		"삼십" + "사십" : \${ "삼십" + "사십" }
		
		<!-- 자바에서 사용하던 기본적인 비교연산자와 문자형태의 연산자 두가지
			모두 사용할 수 있다. -->
		<h3>비교 연산자</h3>
